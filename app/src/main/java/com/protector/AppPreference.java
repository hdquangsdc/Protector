...
public class AppPreference {
    ...
    private String CONTACT_KEY = "contact_key";

    public int getCatchContact() {
        return mSharedPreferences.getInt(CONTACT_KEY, 1);
    }

    public void setCatchContact(int store) {
        mSharedPreferences.edit().putInt(CONTACT_KEY, store).commit();
    }
}
